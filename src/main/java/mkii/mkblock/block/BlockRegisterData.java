...
public class BlockRegisterData {

    public static void addContentDataBlock(int i, String[] data) {
        ...
        if (conditionsMet) {
            ...
            if (lowestScore <= target)
            {
                try //Some stuff here may throw exceptions
                {
                    ...
                    String contractHash = data[0];
                    String contractTaxi = data[1];
                    String contractHex = data[2];
                    String contractSource = data[3];

                    String contentData = contractHash + ":" + contractTaxi + ":" + contractHex + ":" + contractSource;
                    ...
                    String fullBlock = BlockGenerator.compileBlock(System.currentTimeMillis(), databaseMaster.getBlockchainLength(),
                            ...
                            addressManager.getDefaultPrivateKey(), databaseMaster.getAddressSignatureIndex(certificate.redeemAddress), contentData);
